...
expected, the software update did drastically reduce the effectiveness of the
...
\ac{AFP} is able to adapt to the underlying system changes and maintain at
least one useful predictor.
