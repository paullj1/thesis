...
\newcommand{\tabMemLeakPreUpdateSVMConfusionMatrix}{
  \begin{table} \centering
    \tbl{Confusion matrix on test data created before software updates on
    threshold with highest F-Measure (0.8739) using
    \ac{SVM}.\label{tab:memLeakPreUpdateSVMConfusionMatrix}}{%
    \begin{tabular}{llll}
...
\newcommand{\tabMemLeakPostUpdateBoostingSameModelConfusionMatrix}{
  \begin{table} \centering
    \tbl{Post-update failure data confusion matrix on threshold with
