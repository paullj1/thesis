...
\newcommand{\figproactiveFaultManagement}[1]{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figonlinePrediction}[1]{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figfailureFlowDiagram}[1]{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figROC}[1]{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figprecisionRecallCurve}[1]{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figpatternRecognition}[1]{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figAFP}[1]{\begin{figure}[t]
 \begin{center}
    \includegraphics[width=#1]{AFP}
     \caption[\ac{AFP} Framework Implementation~\cite{irrera2015}]{How the
     \ac{AFP} framework is implemented~\cite{irrera2015}.}
     \label{fig:AFP}
 \end{center}
\end{figure}
}
...
\newcommand{\figannotatedAFPcolor}{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figannotatedAFP}{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figTrainingPhase}[1]{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figExecutionPhase}[1]{\begin{figure}[t]
  \begin{center}
...
\newcommand{\figExecutionPhaseHoriz}[1]{\begin{figure}[t]
  \begin{center}
...
\newcommand{\figAuthDCPPS}[1]{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figAuthClientPPS}[1]{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figAuthDCMetrics}[1]{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figOFPTaxonomy}[1]{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figMemLeakROC}[1]{\begin{figure}[t]
 \begin{center}
...
\newcommand{\figMemLeakCompare}[1]{\begin{figure}[t]
 \begin{center}
...
%%%%   SMV   %%%%
% Pre-Update
\newcommand{\figMemLeakPreUpdateSVMPerf}{\begin{figure*}[t]
  \centering
...
%%%%   BOOSTING   %%%%
% Pre-Update
\newcommand{\figMemLeakPreUpdateBoostingPerf}{\begin{figure*}[t]
  \centering
  \subfigure[Precision/Recall Curve.]{
...
% Post-Update (old model)
\newcommand{\figMemLeakPostUpdateSameBoostedModel}{\begin{figure*}[t]
  \centering
  \subfigure[Precision/Recall Curve.]{
...
% Post-Update New Model
\newcommand{\figMemLeakPostUpdateBoostingPerf}{\begin{figure*}[t]
  \centering
  \subfigure[Precision/Recall Curve.]{
...
\newcommand{\figDPLGConceptDiagram}[1]{\begin{figure}[t]
  \centering 
...
\newcommand{\figDPLGAllModsClientMetrics}[1]{\begin{figure}[t]
  \centering
