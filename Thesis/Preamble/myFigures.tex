...
\newcommand{\figMemLeakCombinedANNPerf}{\begin{figure*}[h!t]
  ...
  \caption{Performance of the \ac{ANN} prediction method trained on failure
  data created by consuming all available memory until target application
  fails.} \label{fig:memLeakCombinedANNPerf}
\end{figure*}
}
