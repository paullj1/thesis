...
\begin{table}[htbp]
  \centering
  \caption{Funtion Entry/Exit Patterns (IA32)~\cite{gswfit}}\label{tab:translationThirtyTwo}
...
\begin{table}[htbp]
  \centering
  \caption{Funtion Entry/Exit Patterns (x86-64)~\cite{gswfit}}\label{tab:translationSixtyFour}
\begin{tabular}{ | l | l | l | l | }
\hline
	\multicolumn{2}{|c|}{\textbf{Module Entry Point}}& 
  \multicolumn{2}{c|}{\textbf{Module Exit Point}} \\ \hline
